...
class StudentController extends Controller
{
    ...
    public function mainProfile(Trainer $trainer)
    {
        $user_id = auth()->user()->id;
        $user_data = User::where('id', $user_id)->get();
        $user_courses = Applicant::where([['user_id', $user_id], ['approve', '1']])->get();
        ...
        return view('student.main-profile', compact('user_data', 'user_courses', 'user', 'user_applaycourses', 'user_courses'));
    }
    ...
    public function kids_Details()
    {
        ...
        $user_kids = User::where('parent_id', $user_id)->with([
