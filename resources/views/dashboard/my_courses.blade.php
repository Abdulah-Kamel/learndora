                                    ...
                                    @foreach ($user_courses as $user_course)
                                        ...
                                        <div class="dashboard_single_course">
                                            <div class="dashboard_single_course_thumb">
                                                <img src="{{ asset($user_course->Course->image) }}" class="img-fluid"
                                                    alt="" />
                                                <div class="dashboard_action">
                                                    ...
                                                    @else
                                                        <li><a href="#" class="btn btn-ect">
                                                                {{ __('Not Approved Yet') }}</a></li>
                                                    @endif
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="dashboard_single_course_head_flex">
                                                        ...
                                                        <div class="dashboard_rats">
                                                            <div class="dashboard_rating">
                                                                @for ($i = 1; $i <= 5; $i++)
                                                                    <i
                                                                        class="ti-star @if ($i <= $user_course->Course->rate) filled @endif "></i>
                                                                @endfor

                                                            </div>
                                                            @php
                                                                $comments_count = \App\Comment::where('commentable_type', 'App\Course')
                                                                    ->where('commentable_id', $user_course->Course->id)
                                                                    ->count();
                                                            @endphp
