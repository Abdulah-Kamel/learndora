...
Route::get('refund-privacy-policy', function () {
    return view('privacy');
})->name('privacy');
Route::get('rights-guarantee',      function () {
    return view('rights');
})->name('rights');
...
// Social Login Google
Route::get('auth/google', 'GoogleAuthController@redirectToGoogle')->name('google-auth');
Route::get('auth/google/callback', 'GoogleAuthController@callBackGoogle');
// Social Login Facebook
Route::get('auth/facebook', 'GoogleAuthController@redirectToFacebook')->name('facebook-auth');
Route::get('auth/facebook/callback', 'GoogleAuthController@callBackFacebook');

// Social Login Linked In
Route::get('auth/linkedin', 'GoogleAuthController@redirectToLinkedin')->name('linkedin-auth');
Route::get('auth/linkedin/callback', 'GoogleAuthController@callBackLinkedin');
...
Route::get('/pages/{slug}', 'PagesController@pages')->name('pages');
Route::get('/mainProfile', 'StudentController@mainProfile')->name('mainProfile');
...
Route::get('/news-details/{title}', 'NewsController@single_news')->name('news-details');
Route::get('/course-details/{course}', 'CoursesController@course_details')->name('course_details');
Route::get('/course-details2/{id}}', 'CoursesController@course_details2')->name('course_details2');
Route::get('course/readAsAll', 'CoursesController@readAsAll')->name('readAsAll');
