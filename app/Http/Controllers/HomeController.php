...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // return($news);
        return view('index')->with(['events' => $events, 'users' => $users, 'paid' => $paid, 'free' => $freeCourses, 'partners' => $partners, 'categories' => $categories, 'courses' => $courses, 'count_courses' => $count_courses, 'count_users' => $count_users, 'posts' => $posts, 'trainers' => $trainers, 'services' => $services, 'items' => $items, 'p_categories' => $p_categories, 'products' => $products, 'news' => $news]);
